    ...
    window.Lerc2Decode = (function() {
        ...
        var Lerc2Helpers = {
            ...
            readHuffman: function(input, data, OutPixelTypeArray) {
                 ...
                 *  decode
                 ***************************/
                var val, delta, mask = data.pixels.resultMask,
                    valTmp, valTmpQuick, prevVal = 0,
                    ii = 0;
    ...
    window.Lerc = {
        ...
        decode: function(encodedData, options) {
            ...
            var result = {
                ...
                pixelData: decodedPixelBlock.pixels[0],
                minValue: decodedPixelBlock.statistics[0].minValue,
                maxValue: decodedPixelBlock.statistics[0].maxValue,
                //maskData: data.pixels.resultMask
                noDataValue: 0
            };
