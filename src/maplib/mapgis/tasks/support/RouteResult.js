...
//>>built
define(["dojo/_base/array","../../Graphic","../../core/JSONSupport","./DirectionsFeatureSet"],function(f,d,b,g){return b.createSubclass({declaredClass:"mapgis.tasks.support.RouteResult",properties:{directions:{value:null,type:g},route:{value:null,json:{read:function(a,c){a.geometry&&(a.geometry.spatialReference=c.spatialReference);return d.fromJSON(a)}}},routeName:null,stops:{value:null,json:{read:function(a,c){var e=[],b=c.spatialReference;f.forEach(a,function(a){a.geometry&&(a.geometry.spatialReference=
